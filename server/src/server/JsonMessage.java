...
public class JsonMessage {
    ...
    public static String estado(
            ...
            int atk, int def, int spd, String tipo,
            String opPokemon, int opHp, int opMaxHp, String opTipo,
            List<Move> moves,
    		List<Pokemon> team, int activeIndex) {
        ...
        return String.format(
            ...
            "\"atk\":%d,\"def\":%d,\"spd\":%d,\"tipo_pokemon\":\"%s\"," +
            "\"op_pokemon\":\"%s\",\"op_hp\":%d,\"op_maxHp\":%d,\"op_tipo\":\"%s\"," +
            "\"moves\":%s,\"team\":%s}",
            esc(seupokemon), hp, maxHp, atk, def, spd, tipo,
            esc(opPokemon), opHp, opMaxHp, opTipo,
